...
export type { Emitter, EmitterMap, OpenFileOptions, SaveFileOptions, MessageOptions, ConfirmOptions, NotificationOptions }
...
// Uses `any` (not `unknown`) in the predicate — TypeScript uses `any[]` to check
// "is this a function?" without contravariant narrowing rejecting concrete params.
    ...
    get(_target, prop: string | symbol) {
      ...
      if (prop === "on") {
        return (event: string, handler: (p: unknown) => void) =>
          window.__vorn__.on(event, handler)
      }
...
export const vornWindow = {
  ...
  minimize(): Promise<void>              { return _osCall("window", "minimize") },
  unminimize(): Promise<void>            { return _osCall("window", "unminimize") },
  maximize(): Promise<void>              { return _osCall("window", "maximize") },
  unmaximize(): Promise<void>            { return _osCall("window", "unmaximize") },
  center(): Promise<void>                { return _osCall("window", "center") },
  show(): Promise<void>                  { return _osCall("window", "show") },
  hide(): Promise<void>                  { return _osCall("window", "hide") },
  ...
  isMaximized(): Promise<boolean>  { return _osCall("window", "isMaximized") },
  isMinimized(): Promise<boolean>  { return _osCall("window", "isMinimized") },
  isFullscreen(): Promise<boolean> { return _osCall("window", "isFullscreen") },
  isVisible(): Promise<boolean>    { return _osCall("window", "isVisible") },
...
export const clipboard = {
  readText(): Promise<string>          { return _osCall("clipboard", "readText") },
  writeText(text: string): Promise<void> { return _osCall("clipboard", "writeText", text) },
}
 ...
 */
export const shell = {
  openExternal(url: string): Promise<void>  { return _osCall("shell", "openExternal", url) },
  openPath(path: string): Promise<void>     { return _osCall("shell", "openPath", path) },
}
