...
React to clicks from the frontend with the [`menu`](/docs/v0.1/api/os/menu) API:
...
Handle clicks with the [`tray`](/docs/v0.1/api/os/tray) API:
...
- `async function*` backend handlers return [StreamCall](/docs/v0.1/api/streaming-rpc) handles — awaitable + async-iterable.

## Next

- [Streaming RPC](/docs/v0.1/api/streaming-rpc)
- [Backend RPC guide](/docs/v0.1/guides/backend-rpc)
- [OS API reference](/docs/v0.1/api)
