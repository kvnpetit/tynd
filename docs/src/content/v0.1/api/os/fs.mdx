...
Cross-OS filesystem operations. Binary I/O uses the [zero-copy binary channel](/docs/v0.1/guides/binary-data).
...
Uses the `tynd-bin://` channel — no base64, zero-copy. Accepts `Uint8Array | ArrayBuffer`. See the [Binary Data guide](/docs/v0.1/guides/binary-data).
...
- [path](/docs/v0.1/api/os/path) — path helpers.
- [os](/docs/v0.1/api/os/os) — `dataDir`, `configDir`, `cacheDir`, `tmpDir`.
- [Binary Data guide](/docs/v0.1/guides/binary-data).
