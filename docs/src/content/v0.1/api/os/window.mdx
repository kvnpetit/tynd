...
See the [Multi-Window guide](/docs/v0.1/guides/multi-window).
...
- [monitors](/docs/v0.1/api/os/monitor) — multi-display enumeration.
- [menu](/docs/v0.1/api/os/menu) — app menu bar click handling.
- [Multi-Window guide](/docs/v0.1/guides/multi-window).
