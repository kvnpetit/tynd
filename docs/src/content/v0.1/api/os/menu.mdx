...
Use the standard accelerator syntax's format — same as [`shortcuts`](/docs/v0.1/api/os/shortcuts):
...
- [tray](/docs/v0.1/api/os/tray) — tray menu handlers share the same `menu.onClick` dispatcher.
- [shortcuts](/docs/v0.1/api/os/shortcuts) — global hotkeys (fire unfocused).
