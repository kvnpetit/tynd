...
For explicit cancel mid-run, use [`terminal.spawn`](/docs/v0.1/api/os/terminal) instead — it returns a handle with `kill()`.
...
**Related:** [process API](/docs/v0.1/api/os/process) · [terminal API](/docs/v0.1/api/os/terminal) · [sidecar API](/docs/v0.1/api/os/sidecar).
