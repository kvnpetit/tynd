...
Same TypeScript, same frontend. The only difference is what JS-level globals you can reach inside backend code. See [Runtime Modes](/docs/v0.1/concepts/runtimes).
...
- JS-level globals inside backend code — see [Runtimes](/docs/v0.1/runtimes).
...
- [Runtime Modes](/docs/v0.1/concepts/runtimes) — lite vs full, parity table.
- [IPC Model](/docs/v0.1/concepts/ipc) — call / event / stream flow in detail.
- [Security](/docs/v0.1/concepts/security) — CSP, scheme allowlists, structural model.
