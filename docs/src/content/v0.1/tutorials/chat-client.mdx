...
Exercises: [async-generator RPC](/docs/v0.1/guides/streaming), [`keyring`](/docs/v0.1/api/os/keyring), [`fetch`](/docs/v0.1/api).
...
- **System tray** — minimize to tray for quick ⌘-Space access with a [global shortcut](/docs/v0.1/guides/keyboard-shortcuts).

## Related

- [Streaming RPC guide](/docs/v0.1/guides/streaming).
- [keyring API](/docs/v0.1/api/os/keyring).
- [Persistence guide](/docs/v0.1/guides/persistence).
