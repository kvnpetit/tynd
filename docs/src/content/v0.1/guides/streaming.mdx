...
- **No transferable objects** — values are JSON-serialized each time. For multi-MB binary chunks, use the [binary IPC channel](/docs/v0.1/guides/binary-data) separately and yield handles/IDs over JSON.
