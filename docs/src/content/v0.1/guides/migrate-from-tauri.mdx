...
|---|---|
| `@tauri-apps/plugin-fs` | [`fs`](/docs/v0.1/api/os/fs) |
| `@tauri-apps/plugin-http` | [`http`](/docs/v0.1/api/os/http) (or `fetch`) |
| `@tauri-apps/plugin-shell` | [`shell`](/docs/v0.1/api/os/shell) + [`process`](/docs/v0.1/api/os/process) |
| `@tauri-apps/plugin-dialog` | [`dialog`](/docs/v0.1/api/os/dialog) |
| `@tauri-apps/plugin-clipboard-manager` | [`clipboard`](/docs/v0.1/api/os/clipboard) |
| `@tauri-apps/plugin-notification` | [`notification`](/docs/v0.1/api/os/notification) |
| `@tauri-apps/plugin-os` | [`os`](/docs/v0.1/api/os/os) |
| `@tauri-apps/plugin-process` | [`process`](/docs/v0.1/api/os/process) + [`app.exit`](/docs/v0.1/api/os/app) |
| `@tauri-apps/plugin-global-shortcut` | [`shortcuts`](/docs/v0.1/api/os/shortcuts) |
| `@tauri-apps/plugin-autostart` | [`autolaunch`](/docs/v0.1/api/os/autolaunch) |
| `@tauri-apps/plugin-deep-link` | [`singleInstance.onOpenUrl`](/docs/v0.1/api/os/single-instance) + `protocols` in config |
| `@tauri-apps/plugin-single-instance` | [`singleInstance`](/docs/v0.1/api/os/single-instance) |
| `@tauri-apps/plugin-updater` | [`updater`](/docs/v0.1/api/os/updater) — same manifest format |
| `@tauri-apps/plugin-store` | [`store`](/docs/v0.1/api/os/store) |
| `@tauri-apps/plugin-sql` | [`sql`](/docs/v0.1/api/os/sql) (bundled SQLite) |
| `@tauri-apps/plugin-websocket` | [`websocket`](/docs/v0.1/api/os/websocket) (or native `WebSocket`) |
...
See the [Bundling guide](/docs/v0.1/guides/bundling) for a full matrix example.
...
- [vs Tauri comparison](/docs/v0.1/compare/vs-tauri).
