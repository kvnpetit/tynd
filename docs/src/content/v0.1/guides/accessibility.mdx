...
- Let users remap — see [Keyboard Shortcuts](/docs/v0.1/guides/keyboard-shortcuts) for a user-configurable pattern.
...
- [Keyboard Shortcuts](/docs/v0.1/guides/keyboard-shortcuts).
- [Multi-Window](/docs/v0.1/guides/multi-window) — focus management.
- [Security](/docs/v0.1/concepts/security) — CSP and trusted-content defaults.
