...
- `ArrayBuffer` / `Uint8Array` — use [binary IPC](/docs/v0.1/guides/binary-data) for anything large; for small payloads, base64-encode manually
...
See [Streaming RPC](/docs/v0.1/guides/streaming) for flow control, cancellation, and multi-window routing.
...
- [Streaming RPC](/docs/v0.1/guides/streaming)
- [Binary Data](/docs/v0.1/guides/binary-data)
- [Backend API reference](/docs/v0.1/api/backend)
