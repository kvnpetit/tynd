...
- For multi-MB binary, use [`tynd-bin://`](/docs/v0.1/guides/binary-data) — `fs.readBinary` / `compute.hash`. Don't encode binary as base64 through the JSON channel.
...
- [Binary Data](/docs/v0.1/guides/binary-data) — zero-copy multi-MB IPC.
- [Streaming RPC](/docs/v0.1/guides/streaming) — progressive delivery.
- [Runtimes](/docs/v0.1/runtimes) — lite vs full tradeoff.
