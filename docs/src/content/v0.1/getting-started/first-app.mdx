...
<Callout type="info">
  OS calls bypass the TypeScript backend entirely — the frontend talks straight to the Rust host over the native IPC channel. See [IPC Model](/docs/v0.1/concepts/ipc).
</Callout>
...
See [Bundling & Distribution](/docs/v0.1/guides/bundling) for the full workflow.

## Next

- [Project Structure](/docs/v0.1/getting-started/project-structure)
