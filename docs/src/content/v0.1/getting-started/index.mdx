...
[Bun](https://bun.sh) is required. On Linux you also need the WebKitGTK dev packages — see [Installation](/docs/v0.1/getting-started/installation).
...
<Cards>
  <Cards.Card title="Installation" href="/docs/v0.1/getting-started/installation">
    Bun, WebView deps per OS, verifying the setup.
  </Cards.Card>
  <Cards.Card title="Your First App" href="/docs/v0.1/getting-started/first-app">
    Walk through the backend, the frontend, and the RPC boundary.
  </Cards.Card>
  <Cards.Card title="Project Structure" href="/docs/v0.1/getting-started/project-structure">
    What each file does and where your code goes.
  </Cards.Card>
  <Cards.Card title="Development Workflow" href="/docs/v0.1/getting-started/dev-workflow">
