...
<Cards>
  <Cards.Card title="TypeScript end-to-end" href="/docs/v0.2/concepts/architecture">
    Backend, frontend, RPC — same language, same types.
  </Cards.Card>
  <Cards.Card title="Two runtimes, same API" href="/docs/v0.2/runtimes">
    `lite` for a 6.5 MB binary, `full` for the full Node/Bun surface.
  </Cards.Card>
  <Cards.Card title="Zero-network IPC" href="/docs/v0.2/concepts/ipc">
    RPC and assets never touch TCP — no loopback port, no firewall prompt.
  </Cards.Card>
  <Cards.Card title="Complete API reference" href="/docs/v0.2/api">
...
<Cards>
  <Cards.Card title="Getting Started" href="/docs/v0.2/getting-started">
    Scaffold a project, run it with HMR, produce a release binary.
  </Cards.Card>
  <Cards.Card title="Architecture" href="/docs/v0.2/concepts/architecture">
    Frontend, Rust host, TS backend — how the three surfaces fit.
  </Cards.Card>
  <Cards.Card title="Guides" href="/docs/v0.2/guides">
    Recipes for streaming, multi-window, auto-update, signing, bundling.
  </Cards.Card>
  <Cards.Card title="Comparisons" href="/docs/v0.2/compare">
