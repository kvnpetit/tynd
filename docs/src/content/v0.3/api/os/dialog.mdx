...
- `canCreateDirectories` — (macOS) allow the user to create directories from the picker.
...
- Custom button labels, show-hidden-files, and modal-to-parent aren't currently exposed — see the tracking notes in `COMPARISON.md`.

## Related

- [fs](/docs/v0.3/api/os/fs) — read/write the picked path.
