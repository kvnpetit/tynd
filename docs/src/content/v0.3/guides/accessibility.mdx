...
- Let users remap — see [Keyboard Shortcuts](/docs/v0.3/guides/keyboard-shortcuts) for a user-configurable pattern.
...
- [Keyboard Shortcuts](/docs/v0.3/guides/keyboard-shortcuts).
- [Multi-Window](/docs/v0.3/guides/multi-window) — focus management.
- [Security](/docs/v0.3/concepts/security) — CSP and trusted-content defaults.
