...
| Electron `safeStorage` | [`keyring`](/docs/v0.3/api/os/keyring) — OS credential manager |
| Electron `shell.openExternal` | [`shell.openExternal`](/docs/v0.3/api/os/shell) |
| Electron `clipboard` | [`clipboard`](/docs/v0.3/api/os/clipboard) |
| Electron `dialog` | [`dialog`](/docs/v0.3/api/os/dialog) |
| Electron `Notification` | [`notification.send`](/docs/v0.3/api/os/notification) |
| Electron `Tray` | declare `tray` in `app.start`, handle in [`tray`](/docs/v0.3/api/os/tray) |
| Electron `Menu` | declare `menu` in `app.start`, handle in [`menu`](/docs/v0.3/api/os/menu) |
| Electron `globalShortcut` | [`shortcuts`](/docs/v0.3/api/os/shortcuts) |
| Electron `autoUpdater` | [`updater`](/docs/v0.3/api/os/updater) (Tauri-compatible manifest) |
...
See [Bundling](/docs/v0.3/guides/bundling).
...
If you were signing Electron builds, your certs work as-is — `signtool` and `codesign` are the same tools. Just declare `bundle.sign` in `tynd.config.ts` and `tynd build` handles signing + (optional) notarization. See [Code Signing](/docs/v0.3/guides/code-signing).
...
See [Auto-Updates](/docs/v0.3/guides/auto-updates).
...
See [Security concept](/docs/v0.3/concepts/security).

## Related

- [vs Electron comparison](/docs/v0.3/compare/vs-electron).
