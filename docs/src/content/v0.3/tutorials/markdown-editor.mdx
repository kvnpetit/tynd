...
- **Export to PDF** — bundle a `wkhtmltopdf` [sidecar](/docs/v0.3/api/os/sidecar) and run via `process.exec`.
- **Sync with cloud** — `http.post` to your API with the body; auth token in [`keyring`](/docs/v0.3/api/os/keyring).

## Related

- [fs API](/docs/v0.3/api/os/fs).
- [dialog API](/docs/v0.3/api/os/dialog).
- [menu API](/docs/v0.3/api/os/menu).
