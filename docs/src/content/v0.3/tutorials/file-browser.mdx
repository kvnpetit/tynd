...
Exercises: [`fs.readDir`](/docs/v0.3/api/os/fs), [`fs.readBinary`](/docs/v0.3/api/os/fs) (zero-copy), [`shell.openPath`](/docs/v0.3/api/os/shell), [`os.homeDir`](/docs/v0.3/api/os/os), [`path.join`](/docs/v0.3/api/os/path).
...
- **Search** — recursive walk with [`async function*`](/docs/v0.3/guides/streaming) yielding matches as they're found.
...
- [Binary Data guide](/docs/v0.3/guides/binary-data) — why `fs.readBinary` is fast.
- [shell API](/docs/v0.3/api/os/shell).
- [process API](/docs/v0.3/api/os/process).
