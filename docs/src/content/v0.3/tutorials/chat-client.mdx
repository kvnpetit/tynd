...
Exercises: [async-generator RPC](/docs/v0.3/guides/streaming), [`keyring`](/docs/v0.3/api/os/keyring), [`fetch`](/docs/v0.3/api).
...
- **System tray** — minimize to tray for quick ⌘-Space access with a [global shortcut](/docs/v0.3/guides/keyboard-shortcuts).
