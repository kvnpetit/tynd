...
<Cards>
  <Cards.Card title="Markdown Editor" href="/docs/v0.3/tutorials/markdown-editor">
    File open/save, live preview, keyboard shortcuts, native menu — ~150 LOC.
  </Cards.Card>
  <Cards.Card title="File Browser" href="/docs/v0.3/tutorials/file-browser">
    Directory walker, binary thumbnails via `fs.readBinary`, reveal-in-folder.
  </Cards.Card>
  <Cards.Card title="LLM Chat Client" href="/docs/v0.3/tutorials/chat-client">
...
- [Bun installed](/docs/v0.3/getting-started/installation).
