...
After the frontend and backend builds succeed, `tynd build` concatenates them into a self-extracting binary by appending a **TYNDPKG** trailer to the host executable. See [TYNDPKG Format](/docs/v0.3/concepts/tyndpkg).
...
- [Security](/docs/v0.3/concepts/security)
