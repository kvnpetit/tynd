...
| Emit event to specific window | ✅ `emitTo(label, ...)` | ✅ | ✅ | ✅ |
| Modal window attached to parent | ✅ Win+macOS | ❌ | ✅ | ✅ |
...
| Hide on Escape key | ✅ | ❌ | ✅ | ❌ |
| Visible on all workspaces (macOS) | ❌ | ✅ | ❌ | ✅ |
| Window-scoped event listeners | ✅ via emitTo | ✅ | ❌ | ✅ |
...
| Update menu item by ID at runtime | ⚠️ full setMenu replace | ✅ | ✅ | ⚠️ |
...
| Clear clipboard | ✅ | ✅ | ❌ | ✅ |
| Clipboard change monitoring | ✅ polled | ✅ | ❌ | ⚠️ |
...
| Sound | ✅ | ✅ | ❌ | ✅ |
| Scheduled (delayed / recurring) | ✅ delayed | ✅ | ❌ | ❌ |
| Notification groups | ❌ | ✅ | ❌ | ❌ |
| Cancel / remove notifications | ⚠️ scheduled only | ✅ | ❌ | ✅ |
...
| Firewall prompt | ❌ | ❌ | ✅ | ❌ |
| Invoke timeout | ✅ `withTimeout` | ❌ | ✅ | ❌ |
| Call cancellation | ✅ `handle.cancel()` + AbortSignal | ❌ | ✅ | ❌ |
...
| Feature | Tynd | Tauri v2 | Wails v3 | Electron |
|---|---|---|---|---|
| Capability-based ACL | ✅ opt-in | ✅ | ❌ | ❌ |
| Default-deny model | ✅ opt-in | ✅ | ❌ | ❌ |
...
| `findInPage` (Cmd+F style) | ✅ via window.find | ❌ | ❌ | ✅ |
| `stopFindInPage` | ✅ | ❌ | ❌ | ✅ |
...
| System tray | 12/20 | 15/20 | 18/20 | 14/20 |
...
| IPC & Events | 11/23 | 17/23 | 11/23 | 17/23 |
...
| **Total** | **~227/503 (45%)** | **~368/503 (73%)** | **~189/503 (38%)** | **~357/503 (71%)** |
